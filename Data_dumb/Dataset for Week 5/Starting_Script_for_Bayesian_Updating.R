...
# set-up from first Baseline data
...
write.csv(final.output, file = "Global_Result_2017-1.csv", row.names = FALSE)
...
stan.dataset.2017_2=list(N=n, N_edges=n_edges, node1=nod1, node2=nod2, Y=y, X=x, K=length(x), off_set=e)
