...
If you are a MAC user, go to [**section 1.2.1**](https://uclpg-msc-sgds.github.io/GEOG0125/getting-started.html#installation-process-for-mac-users)

If you are a Windows user, jump to [**section 1.2.2**](https://uclpg-msc-sgds.github.io/GEOG0125/getting-started.html#installation-process-for-windows-users)
...
If you already installed them, you can jump straight to the [**section 1.3**](https://uclpg-msc-sgds.github.io/GEOG0125/getting-started.html#installation-of-rstan-or-stan) to install **Stan**.
...
If you have these installed already - you can jump to the [**section 1.3**](https://uclpg-msc-sgds.github.io/GEOG0125/getting-started.html#installation-of-rstan-or-stan) on installing **Stan**.
