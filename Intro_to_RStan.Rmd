...
## Lecture recording (Length: 59:50 minutes)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_msstream('b5586b26-ea2f-489c-84f4-ff4182372cb1', height=400) %>% use_align('center')
```

<div class="note">
**Important Notes:** If this or any subsequent video don't play from this website, then try playing it directly from Microsoft Streams - you should be able to view it by clicking this [**[LINK]**](https://web.microsoftstream.com/video/b5586b26-ea2f-489c-84f4-ff4182372cb1). Access to Microsoft Steams to these videos will require use of your UCL institutional login details.
</div>
...
### Demonstration recording (Length: 38:23 minutes)
```{r, warnings=FALSE, message=FALSE, echo=FALSE}
library(vembedr)
embed_msstream('e70853ca-4452-4363-9474-539547a238f9', height=400) %>% use_align('center')
```

<div class="note">
**Important Notes:** If this or any subsequent video don't play from this website, then try playing it directly from Microsoft Streams - you should be able to view it by clicking this [**[LINK]**](https://web.microsoftstream.com/video/e70853ca-4452-4363-9474-539547a238f9). Access to Microsoft Steams to these videos will require use of your UCL institutional login details.
</div>
...
To start writing scripts for Bayesian analysis, we will need to install a package called `rstan`.

```{r, eval = FALSE}
# setting timer over 100s to extend timeout::: just in case
options(timeout=100)

# install package rstan with its dependency
...
We can use this information in fact to make a prediction on the current 2022/23 cohort - hmmm, I wonder... how many of you will get a distinction in GEOG0125? Let's see:

- Total sample size is now 26 (N)
